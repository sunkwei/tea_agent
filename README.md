...
[![Version](https://img.shields.io/badge/version-0.16.11-blue)](https://pypi.org/project/tea-agent)
...
| 🧰 **工具驱动** | 64 个内置工具（文件/代码/搜索/截图/浏览器/包管理/Git），运行时热插拔 |
...
当前 **55 个工具模块 / 64 个注册工具**，其中 62 个对模型可见（2 个内部工具不暴露）。
