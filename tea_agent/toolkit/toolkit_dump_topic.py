...
def meta_toolkit_dump_topic() -> dict:
    return {"type": "function", "function": {"name": "toolkit_dump_topic", "description": "将当前所有会话内容从数据库导出到 dump_{date} 子目录，每个 topic 对应一个 markdown 文件。", "parameters": {"type": "object", "properties": {}, "required": []}}}
