...
def meta_toolkit_memory() -> dict:
    ...
    return {
        ...
        "function": {
            "name": "toolkit_memory",
            "description": "统一长期记忆管理。action: add/list/search/forget/extract/auto_extract/semantic_search/stats。add需content；forget需id；search可选query；list可选limit。",
            "parameters": {
                "type": "object",
                "properties": {
                    "action": {
                    ...
                    "hard": {"type": "boolean", "description": "是否硬删除，默认false(软删除)", "default": False},
                    "query": {"type": "string", "description": "搜索关键词", "default": ""},
                    "min_importance": {"type": "integer", "description": "最低重要度 1-5", "default": 0},
                    "limit": {"type": "integer", "description": "返回数量上限", "default": 10},
                    "topic_id": {"type": "string", "description": "topic ID", "default": ""},
                    "max_chars": {"type": "integer", "description": "返回文本最大字符数", "default": 4000},
                    "force": {"type": "boolean", "description": "是否强制提取（忽略去重）", "default": False},
                    "top_k": {"type": "integer", "description": "返回数量上限", "default": 10},
                },
                "required": ["action"],
            },
        },
