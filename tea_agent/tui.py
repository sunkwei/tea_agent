...
class _TUIAgentCore(AgentCore):
    ...
    Inherits AgentCore for config/Storage/Toolkit/session/post-processing,
    overrides _on_post_reply and _on_init_done, and implements TUI-style _chat.
    """
    ...
    def _init_agent(self):
        ...
        try:
            self.agent = _TUIAgentCore(
                ...
                enable_think=self._cli_think,
                verbose=self._cli_verbose,
